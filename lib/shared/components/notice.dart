...
// Widget AddNoticeItem(w, student, date, index, context, content, cubit,type) =>
//     Container(
//       width: 4 / 5 * w,
//       height: 50,
...
//
//
// Widget AddNoticeBuilder(w, students, type, date, context, state, contents, cubit) =>
//     ConditionalBuilder(
...
//                 index, context, contents[index], cubit);
//           },
...
Widget AddNoticeItem(w, student, type, date, index, context, controller,
        AddNoticeCubit cubit) =>
    Container(
      width: 4 / 5 * w,
      height: 50,
      decoration: BoxDecoration(
...
Widget AddNoticeBuilder(
        w, students, type, date, context, state, controllers, cubit) =>
    ConditionalBuilder(
      condition: state is! AddNoticeLoadingState && students != null,
      builder: (context) => ListView.separated(
          itemBuilder: (context, index) {
