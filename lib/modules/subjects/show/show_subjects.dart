...
class SubjectsShow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (BuildContext context) => ShowSubjectsCubit()..getSubjects(),
      child: BlocConsumer<ShowSubjectsCubit, ShowSubjectsStates>(
        listener: (context, state) {},
        builder: (context, state) {
          var cubit = ShowSubjectsCubit.get(context);
          return Padding(
            ...
            child: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Expanded(
                      child: ShowSubjectsBuilder(
                          w,
                          cubit.subjectModel?.data,
                          context,
                          state
                      )
                  )
